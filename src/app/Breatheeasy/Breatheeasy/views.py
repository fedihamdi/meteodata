...
def pollen_data_view(request):
    ...
    try:
        ...
        filtered_df, user_latitude, user_longitude, pollen_estimated = filter_data_user_position(only_data=True)
    except Exception as e:
        logger_me.warning(f"This is failing 4"
                          f"{e}")
